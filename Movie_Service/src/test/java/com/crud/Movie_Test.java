...
public class Movie_Test {
	...
	public void testSave() {
		...
		ResponseEntity<Movie_Test> rs=ts.postForEntity(
				"http://localhost:"+port+"/save",
				new HttpEntity<>(mv),Movie_Test.class
				);
		assertEquals(HttpStatus.OK, rs.getStatusCode());
		System.out.println(rs.getBody());
		
		ResponseEntity<Movie_Test> rs1=ts.postForEntity(
				"http://localhost:"+port+"/save",
				new HttpEntity<>(mv1),Movie_Test.class
				);
	...
	public void getMovieTest() {
		...
		Long id=1l;
		ResponseEntity<Movie_Test> rs=ts.getForEntity(
				"http://localhost:"+port+"/"
				+id,Movie_Test.class
				);
	...
	public void updateMovie() {
		...
		ResponseEntity<Movie_Test> rs=ts.exchange("http://localhost:"+port+"/"+id,
				HttpMethod.PUT, new HttpEntity<>(mve), Movie_Test.class);
	...
	public void deleteMovie() {
		...
		ResponseEntity<Movie_Test> rs=ts.exchange("http://localhost:"+port+"/"+id,
				HttpMethod.DELETE,null, Movie_Test.class);
